...
`spec.url`, and a checksum over the exact `.flatpakrepo` response bytes. Fluxion downloads and
...
repository base URL is not a finite artifact that Fluxion can verify.
