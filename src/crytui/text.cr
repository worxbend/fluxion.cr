module CryTUI
  ...
  struct Line
    ...
    # a colour for the ordinary background — an item count in `muted`, a
    # shortcut in `warning` — and some of those choices stop working once the
    # row is repainted in the highlight colours.
