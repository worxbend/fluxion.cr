module CryTUI
  ...
  module TextWidth
    ...
    # Unicode 15.1 W/F and default emoji-presentation ranges used by
    # unicode-width 0.2, Ratatui 0.29's width implementation. Ambiguous-width
    # symbols remain narrow. This matters for TUI glyphs such as ▶, 🎚 and ⚠.
    WIDE_RANGES = [
      ...
      0x3030..0x303E, 0x3041..0x3096, 0x309B..0x30FF, 0x3105..0x312F,
      0x3131..0x3163, 0x3165..0x318E, 0x3190..0x31E3, 0x31EF..0x321E,
